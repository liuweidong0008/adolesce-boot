package com.boot.module.demo;

import com.alibaba.fastjson.JSON;
import com.boot.framework.annotation.RequestParamsTrim;
import com.boot.framework.properties.DemoProperties;
import com.boot.framework.properties.MyProperties;
import com.boot.module.commonbean.MyParam;
...
public class DemoController {
     ...
     * @param address
     * @return
     * @throws UnsupportedEncodingException 调用：http://localhost:8081/spring_boot/testGetStringRequest?name=刘威东
     */
     ...
     *
     * @param paramMap
     * @return 调用：http://localhost:8081/spring_boot/testGetMapRequest?userName=lwd&age=12&address=123123
     */
     ...
     *
     * @param users
     * @return 调用：http://localhost:8081/spring_boot/testGetEntityRequest?userName=lwd&age=12&address=123123
     */
     ...
     *
     * @param name
     * @return 调用：http://localhost:8081/spring_boot/testPostStringRequest
     */
     ...
     *
     * @param paramMap
     * @return 调用：http://localhost:8081/spring_boot/testPostMapRequest
     */
     ...
     *
     * @param users
     * @return 调用：http://localhost:8081/spring_boot/testPostEntityRequest
     */
     ...
     *
     * @param paramMap
     * @return 调用：http://localhost:8081/spring_boot/testPostMapJsonRequest
     */
     ...
     *
     * @param users
     * @return 调用：http://localhost:8081/spring_boot/testPostEntityJsonRequest
     */
     ...
     *
     * @param ids
     * @return 调用：http://localhost:8081/spring_boot/testIdsAccept?ids=1,2,3,4
     */
