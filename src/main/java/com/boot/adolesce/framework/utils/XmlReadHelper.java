 ...
 *******************************************************************************/
package com.boot.adolesce.framework.utils;

import cn.hutool.core.collection.CollUtil;
import com.boot.adolesce.framework.utils.excel.imports.ExcelImportConfig;
import com.boot.adolesce.framework.utils.excel.export.ExcelSheet;
...
public class XmlReadHelper {
    ...
    private static Map<String, ExcelImportConfig> excelImportConfigMap = new HashMap<String, ExcelImportConfig>();

    static{
        try {
            //解析Excel导出配置文件
            ClassPathResource configFile = new ClassPathResource("config/excelExportConfig.xml");
            paseExcelExportConfig(configFile.getFile());
            //解析Excel导入配置文件
            configFile = new ClassPathResource("config/excelImportConfig.xml");
